 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.travelport.com/schema/util_v38_0}CalculateTaxResult"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends BaseRsp
{
    ...
    /**
     * Gets the value of the calculateTaxResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the calculateTaxResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link CalculateTaxResult }
