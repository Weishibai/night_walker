 ...
 * 			
 * 
 * <p>Java class for typeOTAKeyword complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="SubKey" type="{http://www.travelport.com/schema/common_v38_0}typeOTASubKey" maxOccurs="99" minOccurs="0"/&gt;
...
@XmlType(name = "typeOTAKeyword", propOrder = {
    "subKey",
    "text"
})
    ...
    implements Locatable
{
    ...
    public List<TypeOTASubKey> getSubKey() {
        if (subKey == null) {
            subKey = new ArrayList<TypeOTASubKey>();
        }
        return this.subKey;
    }
