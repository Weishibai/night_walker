...
/**
 * <p>Java class for typeRailReservationRsp complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="typeRailReservationRsp"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "typeRailReservationRsp", propOrder = {
    "universalRecord"
})
@XmlSeeAlso({
    RailExchangeRsp.class
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2016-09-13T11:33:11-06:00", comments = "JAXB RI v2.2.11")
public abstract class TypeRailReservationRsp
    extends BaseRsp
{

    @XmlElement(name = "UniversalRecord", namespace = "http://www.travelport.com/schema/universal_v38_0")
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2016-09-13T11:33:11-06:00", comments = "JAXB RI v2.2.11")
