...
public class HotelService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.travelport.com/service/hotel_v42_0", "HotelService");
    public final static QName HotelKeywordsServicePort = new QName("http://www.travelport.com/service/hotel_v42_0", "HotelKeywordsServicePort");
    public final static QName HotelMediaLinksServicePort = new QName("http://www.travelport.com/service/hotel_v42_0", "HotelMediaLinksServicePort");
    public final static QName HotelRetrieveServicePort = new QName("http://www.travelport.com/service/hotel_v42_0", "HotelRetrieveServicePort");
    public final static QName HotelSearchServicePort = new QName("http://www.travelport.com/service/hotel_v42_0", "HotelSearchServicePort");
    public final static QName HotelRulesServicePort = new QName("http://www.travelport.com/service/hotel_v42_0", "HotelRulesServicePort");
    public final static QName HotelDetailsServicePort = new QName("http://www.travelport.com/service/hotel_v42_0", "HotelDetailsServicePort");
    public final static QName HotelSuperShopperServicePort = new QName("http://www.travelport.com/service/hotel_v42_0", "HotelSuperShopperServicePort");
    public final static QName HotelSearchAvailabilityAsynchServicePort = new QName("http://www.travelport.com/service/hotel_v42_0", "HotelSearchAvailabilityAsynchServicePort");
    public final static QName RetrieveHotelSearchAvailabilityServicePort = new QName("http://www.travelport.com/service/hotel_v42_0", "RetrieveHotelSearchAvailabilityServicePort");
    public final static QName HotelUpsellSearchServicePort = new QName("http://www.travelport.com/service/hotel_v42_0", "HotelUpsellSearchServicePort");
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Travelport_1/SamplesAutoMation/AutoWork/travelport-uapi-tutorial-v42/wsdl/hotel_v42_0/Hotel.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HotelService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Travelport_1/SamplesAutoMation/AutoWork/travelport-uapi-tutorial-v42/wsdl/hotel_v42_0/Hotel.wsdl");
        }
        WSDL_LOCATION = url;
    }
