...
public class HotelService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.travelport.com/service/universal_v38_0", "HotelService");
    public final static QName HotelReservationServicePort = new QName("http://www.travelport.com/service/universal_v38_0", "HotelReservationServicePort");
    public final static QName HotelCancelServicePort = new QName("http://www.travelport.com/service/universal_v38_0", "HotelCancelServicePort");
    static {
        URL url = null;
        try {
